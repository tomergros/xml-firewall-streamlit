...
def main():
    ...
    st.markdown("1. Click on the arrow to start the app.")
    st.markdown("2. Browse an XSD file.")
    st.markdown("3. Browse an XML file.")
    st.markdown("4. Click on 'Validate'.")
    st.markdown("That's it! You are ready to go!")
